...
(function(){
  ...
  const SYNONYMS = {
    ...
    'purysens':  ['purysens', 'pelle sensibile', 'hypoallergenico', 'ipoallergenico', 'delicato', 'reattiva'],
    'illumia':   ['illumia', 'illuminante', 'macchie', 'iperpigmentazione', 'discromia', 'niacinamide', 'vitamina c', 'stabilizzata', 'liquirizia', 'glow'],
  ...
  const LINES = [
    ...
    { type: 'line', title: 'Purysens', title_en: 'Purysens', url: '/linee/linea.html?id=purysens', tags: ['purysens', 'pelle sensibile', 'ipoallergenico'] },
