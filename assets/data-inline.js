window.ATH_DATA_JSON = {
  ...
  "company": {
    ...
    "history": [
      ...
      },
      {
        ...
        "description": "Ampliamento dello stabilimento e implementazione dell'automazione. Inizio attività di export in vari paesi europei e USA."
      },
      {
        "year": "2003",
  ...
  "partnerships": {
    "universita-ferrara": {
      "name": "Università di Ferrara — Dipartimento di Cosmetologia",
      "type": "Partnership scientifica",
      "scope": "Test efficacia, tollerabilità cutanea e oculare, controllo microbiologico"
    },
    "opimm": {
      "name": "OPIMM — Centro di lavoro protetto",
      "type": "Inclusione lavorativa",
      "scope": "Confezionamento secondario in collaborazione con persone con disabilità",
      "website": "www.opimm.it"
    },
    "lifegate": {
      "name": "LifeGate — Programma Impatto Zero®",
      "type": "Compensazione CO₂",
  ...
  "certifications": {
    "plant-based": {
      ...
      "authority": "Bioagricert · www.bioagricert.org",
      "third_party": true
    },
    "vegan": {
      "name_it": "Vegan",
    ...
    "dermatologico": {
      ...
      "desc_it": "Studi di efficacia, tollerabilità cutanea/oculare e controllo microbiologico in collaborazione col Dipartimento di Cosmetologia, Università di Ferrara.",
      "authority": "Università di Ferrara",
      "third_party": true
    },
    "energia-solare": {
    ...
    "impatto-zero": {
      "name_it": "Impatto Zero®",
      "name_en": "Zero Impact®",
      "desc_it": "Le emissioni di CO₂ del packaging sono compensate da progetti forestali (Italia, Madagascar, Costa Rica, Panama, Nuova Zelanda).",
      "authority": "LifeGate",
      "third_party": true,
      "scope": "Linee L'Erboristica + EVERBY"
    },
    "test-metalli": {
      "name_it": "Test Nichel · Cromo · Cobalto",
      "name_en": "Nickel · Chromium · Cobalt Tested",
      "desc_it": "Tutti i prodotti L'Erboristica e EVERBY testati per i tre metalli pesanti più allergeni.",
  ...
  "brands": {
    ...
    "sphea": {
      "name": "Sphea",
      "since": 2025,
      "tagline": "Alta gamma · Pearl Biopolymer Technology"
    }
  },
  "lines": {
    "antieta": {
      "name_it": "Antietà Globale",
    ...
    "cocco": {
      "name_it": "Olio di Cocco e Olio di Monoï",
      "name_en": "Coconut & Monoï Oil",
      "brand": "erboristica",
      "tagline_it": "Olio di cocco con monoï di Tahiti",
      "palette": "cocco",
      "sort_order": 3
    },
    "mandorle": {
    ...
    "nutra": {
      ...
      "brand": "erboristica",
      "tagline_it": "Olio di baobab, burro karité, ceramidi vegetali",
      "palette": "nutra",
      "sort_order": 8
    },
    "pearls": {
      "name_it": "Pearls — Skincare Innovation",
      "name_en": "Pearls — Skincare Innovation",
      "brand": "erboristica",
    ...
    "kaley": {
      "name_it": "Kaley — Roll-on Concentrati",
      "name_en": "Kaley — Concentrated Roll-on",
      "brand": "kaley",
    ...
    "sphea": {
      "name_it": "Sphea — Pearl Biopolymer Technology",
      "name_en": "Sphea — Pearl Biopolymer Technology",
      "brand": "sphea",
  ...
  "products": [
    {
      ...
      "subtitle_it": "La crema antirughe per il contorno occhi, a base di acido ialuronico e collagene vegetale, è ideale per tutti i tipi di pelle. Senza profumo, dona un’ottima compattezza cutanea e un’intensa azione ridensificante e rassodante.",
      "description_it": "Questa straordinaria crema contorno occhi, che restituisce giovinezza allo sguardo, contiene Acido Ialuronico e Collagene Vegetale da bio-fermentazione.",
    ...
    },
    {
      ...
      "subtitle_it": "La crema viso giorno antietà globale contiene il % di ingredienti di origine naturale. È una crema giorno fresca e leggera, adatta per ogni stagione.",
      "description_it": "La crema viso giorno all’Acido Ialuronico e all’Estratto di Alghe Rosse, dona un’idratazione intensa alla pelle per l’interna giornata.",
    ...
    },
    {
      ...
      "subtitle_it": "Cerchi un detergente struccante delicato che lasci la tua pelle idratata? Scegli il detergente struccante ideato da Erboristica Athena’s con il % di ingredienti di origine naturale. Vellutato come un latte ed efficace come un detergente, strucca viso, occhi e labbra.",
      "description_it": "Il detergente struccante ideato da Erboristica Athena’s, vellutato come un latte ed efficace come un detergente, strucca viso, occhi e labbra, rimuovendo completamente il make-up.",
    ...
    },
    {
      ...
      "subtitle_it": "Trattamento intensivo rimpolpante 21 giorni di trattamento d’urto",
      "description_it": "Per una pelle compatta e luminosa scegli questo trattamento di bellezza innovativo, pro-giovinezza, estremamente piacevole.",
    ...
    },
    {
      ...
      "subtitle_it": "Il siero viso antietà globale all’acido ialuronico vegetale con il 8% di ingredienti di origine naturale. È un essenziale trattamento per il viso adatto a tutti i tipi di pelle che in qualsiasi momento della giornata regala freschezza e vitalità in profondità.",
      "description_it": "L’Acido Ialuronico Vegetale, estratto da una pianta originaria del Giappone trattiene le molecole d’acqua e conferisce una perfetta idratazione ai tessuti cutanei.",
    ...
    },
    {
      ...
      "subtitle_it": "Il siero viso al collagene vegetale antietà globale con il % di ingredienti di origine naturale ridona una meravigliosa compattezza cutanea e svolge un’azione rassodante e ridensificante.",
      "description_it": "Il collagene vegetale, da bio-fermentazione, contenuto nel siero, ripara in maniera naturale e rinforza le fibre di sostegno della pelle.",
      "usage_it": "Perfetto da solo in ogni momento della giornata su viso e dècolleté. La miscelazione di alcune gocce ai Trattamenti viso Antietà Globale ne potenzia l’effetto.",
    ...
    },
    {
      ...
      "subtitle_it": "Con il 8% di ingredienti di origine naturale questa crema viso antietà globale è un trattamento antirughe intensivo con Collagene Vegetale e Omega 3 & 6.",
      "description_it": "La crema viso fondente antietà globale rimodella il viso, ricompatta la pelle, restituendo giovinezza e perfezione.",
    ...
    },
    {
      ...
      "subtitle_it": "La crema corpo idratante all’olio di cocco dalla fragranza avvolgente dai numerosi ingredienti di origine vegetale. È idratante, antiossidante e levigante. La pelle diventa morbida e profumata e non unta, grazie alla formula ad assorbimento rapido.",
      "description_it": "La crema corpo idratante dall’ irresistibile fragranza esotica, dolce ed avvolgente del cocco.",
    ...
    },
    {
      ...
      "subtitle_it": "Maschera capelli Olio di Cocco & Monoi, profonda idratazione dalla radice alle punte",
      "description_it": "Maschera all’Olio di Cocco e Olio di Monoï , per avere capelli straordinariamente morbidi e luminosi.",
    ...
    },
    {
      ...
      "subtitle_it": "Mousse Doccia al Cocco",
      "description_it": "Questa mousse doccia ha il profumo tipico del cocco, dolce e avvolgente, che permea di sé ogni cosa.",
    ...
    },
    {
      ...
      "subtitle_it": "Olio Corpo e Capelli Cocco e Monoi elasticizzante e idratante rende la pelle vellutata e morbida. Questo prodotto, 100% naturale e dal profumo esotico e avvolgente, aiuta e protegge l’abbronzatura, se utilizzato come doposole.",
      "description_it": "Olio 100% naturale di Cocco e Monoï di Tahiti: elasticizza la pelle, nutre i capelli e prolunga l’abbronzatura con il suo profumo esotico e avvolgente.",
    ...
    },
    {
      ...
      "subtitle_it": "Olio secco illuminante multifunzione per corpo e capelli con Olio di Cocco e Monoï. Nutre, illumina e dona un effetto glow naturale senza ungere.",
      "description_it": "Olio secco multifunzione per corpo e capelli con Olio di Cocco e Monoï: illumina, nutre e regala un effetto glow naturale senza residui untuosi.",
    ...
    },
    {
      ...
      "subtitle_it": "Scrub corpo con Olio di Cocco & Monoï e granuli di Albicocca",
      "description_it": "Il profumo inebriante del Cocco e le dolci note del Monoi di Thaiti rendono unico questo scrub corpo in crema.",
    ...
    },
    {
      ...
      "subtitle_it": "Lo Shampoo al Cocco dalla funzione idratante e protettiva è ideale per capelli spenti e danneggiati.",
      "description_it": "Shampoo delicato con tensioattivi di origine vegetale che mantengono l’idratazione dei capelli anche con uso frequente.",
    ...
    },
    {
      ...
      "subtitle_it": "Spray idratante multifunzione — viso, corpo e capelli, senza alcool",
      "description_it": "Spray idratante multifunzione senza alcool con Olio di Cocco e Aloe Vera: idrata e rinfresca all’istante viso, corpo e capelli.",
    ...
    },
    {
      ...
      "subtitle_it": "Mousse detergente ultra-delicata con Acqua di Riso Fermentata e Centella. Pulisce, lenisce e illumina la pelle, lasciandola morbida, fresca e idratata.",
      "description_it": "Cica Cloud è una mousse detergente ultra-delicata che unisce efficacia e sensorialità in un trattamento quotidiano ideale anche per pelli sensibili e facilmente reattive. La sua texture soffice e cremosa, leggera come una nuvola, deterge la pelle rimuovendo impurità e residui di make-up senza alterare l’equilibrio cutaneo e senza lasciare la pelle secca o che tira. Fin dalla detersione, la pelle appare più fresca, morbida e visibilmente luminosa, trasformando il primo step della skincare in un vero momento di benessere. Contiene: Acqua di Riso Fermentata : ricca di aminoacidi, aiuta a rinforzare la barriera cutanea, mantenere l’idratazione e migliorare la luminosità della pelle. Centella Asiatica : attivo lenitivo e riequilibrante, riduce i rossori e dona comfort alle pelli sensibili e reattive.",
    ...
    },
    {
      ...
      "subtitle_it": "Microperle Illuminanti + Estratto di Caffè Illumina e corregge Le microperle minerali mascherano borse e occhiaie sin dalla prima applicazione, regalando luminosità e levigatezza . Drena e sgonfia L’ Estratto di Caffè stimola il microcircolo con un’azione drenante e decongestionante , per uno sguardo sempre fresco e riposato. ‍ Effetto immediato e trattamento a lungo termine! Riduce visibilmente borse e occhiaie con un’azione lenitiva, drenante e lipolitica . Formula ricca di attivi preziosi per prenderti cura del tuo sguardo ogni giorno! Perfetto per chi desidera uno sguardo luminoso e disteso in pochi gesti!",
      "description_it": "DON’T CALL ME PANDA – CONTORNO OCCHI BORSE & OCCHIAIE Microperle Illuminanti correttive + Estratto di Caffè Formula ricca di preziosi attivi, svolge due funzioni in un unico prodotto: • le microperle minerali illuminanti e correttive con azione soft-focus, mascherano borse ed occhiaie già dalla prima applicazione, conferendo luminosità e levigatezza, • l’Estratto di Caffè favorisce il microcircolo con un’azione drenante e sgonfiante per uno sguardo fresco e riposato ogni giorno. Riduce efficacemente borse e occhiaie con un’azione drenante, lipolitica e lenitiva sul contorno occhi. ATTIVI • Luminescine®: attivo naturale biologico, conferisce luminosità e radiosità alla pelle. • Fitosoma Di Escina + Beta-Sitosterolo: azione lenitiva e sgonfiante. • Niacinamide + Vitamina C Stabilizzata: schiarente, illuminante, rigenerante e antirughe. • Burro Di Karitè: nutriente e protettivo.",
    ...
    },
    {
      ...
      "subtitle_it": "Feel Butter – La coccola che la tua pelle merita! Un 3 in 1 che: Deterge delicatamente Rimuove anche il trucco più resistente (anche waterproof!) Lascia la pelle setosa e idratata, senza residui oleosi Come funziona? 1⃣ Gel trasparente Si fonde sulla pelle e scioglie il trucco di viso, occhi e labbra. 2⃣ A contatto con l’acqua Si trasforma in un latte cremoso per una detersione profonda. 3⃣ Dopo il risciacquo Pelle morbida, idratata e luminosa . Per un’esperienza di detersione unica, ogni giorno!",
      "description_it": "Formulato con ingredienti di origine naturale e delicatissimi, Feel Butter è un prodotto 3 in 1 che deterge delicatamente, strucca anche il trucco più resistente e lascia la pelle meravigliosamente setosa e idratata senza residui oleosi! Si presenta come un gel trasparente che fonde sulla pelle, dissolve per affinità il trucco, anche quello waterproof di viso, occhi e labbra, si emulsiona con acqua trasformandosi in un latte cremoso e si risciacqua regalando alla pelle morbidezza e idratazione, per un’esperienza di detersione unica. ATTIVI • Blend Vitaminico A-C-E: rigenerante, antiossidante, illuminante • Fitosteroli: protettivi della barriera cutanea • Blend di 3 Oli Vegetali: nutrienti, emollienti • Esteri dello Zucchero di Origine Vegetale: idratanti, setificanti",
    ...
    },
    {
      ...
      "subtitle_it": "Pigmenti perlati + Acido Ialuronico Illumina, idrata e valorizza la tua pelle in un solo gesto! Effetto glow naturale – Dona al viso un tocco di colore leggero e radioso. Texture setosa e modulabile – Sfuma facilmente e si adatta alla tua intensità preferita. Pigmenti minerali perlati – Luminosità delicata e adatta a ogni incarnato. Acido Ialuronico – Idrata in profondità per una pelle liscia e uniforme. Perfetto da solo o mixato con il fondotinta per un effetto personalizzato!",
      "description_it": "YES I GLOW- GOCCE VISO ILLUMINANTI Pigmenti perlati + Acido Ialuronico Gocce illuminanti che ravvivano il viso con un tocco di colore leggero e naturale. La texture setosa permette di ottenere un’intensità modulabile. Si sfuma facilmente e si fonde perfettamente con la pelle, offrendo una luminosità che dura tutto il giorno. I Pigmenti minerali perlati donano un bagliore delicato e radioso ad ogni tonalità di pelle. Inoltre, l’Acido Ialuronico garantisce un’idratazione profonda, lasciando la pelle levigata, sana e uniforme. ATTIVI Pigmenti minerali perlati colorati: • azione illuminante • soft-focus • setificante • Acido Ialuronico: idratante, levigante",
    ...
    },
    {
      ...
      "subtitle_it": "Tonico viso lattiginoso idratante con Acqua di Riso Fermentata e Niacinamide. Rinforza la barriera cutanea, illumina e uniforma la pelle per un effetto glass skin immediato.",
      "description_it": "Milky Rice è un tonico viso lattiginoso idratante di nuova generazione, studiato per rinforzare la barriera cutanea e donare alla pelle un immediato effetto glass skin: levigata, luminosa e visibilmente più uniforme. Non è un semplice tonico, ma un vero trattamento che idrata, lenisce e prepara la pelle ai successivi step della skincare. La sua texture setosa e leggera avvolge il viso in un velo di comfort, contribuendo a ridurre rossori e segni di stress cutaneo. Si assorbe rapidamente, non appiccica e lascia la pelle morbida, fresca e radiosa fin dalla prima applicazione. Perfetto per l’uso quotidiano, aiuta a migliorare la qualità della pelle giorno dopo giorno, rendendola più compatta, uniforme e luminosa. Contiene: Acqua di Riso Fermentata : ricca di aminoacidi e minerali, aiuta a rinforzare la barriera cutanea, migliorare l’idratazione e donare luminosità all’incarnato. Niacinamide : contribuisce ad affinare la grana della pelle, uniformare il colorito e migliorare la luminosità naturale.",
    ...
    },
    {
      ...
      "subtitle_it": "Struccante bifasico occhi delicato che rimuove anche il make-up waterproof senza irritare. Con Aloe Vera e Omega 3-6, deterge, lenisce e nutre la zona perioculare.",
      "description_it": "No Cry Zone è lo struccante bifasico occhi ultra-delicato studiato per rimuovere efficacemente anche il make-up waterproof in un solo gesto, rispettando la sensibilità della zona perioculare. La sua formula combina efficacia e delicatezza, eliminando ogni traccia di trucco senza irritare e senza lasciare residui oleosi. Ideale anche per occhi sensibili, dona una piacevole sensazione di comfort e freschezza, lasciando la pelle morbida, pulita e perfettamente detersa. La texture leggera e bilanciata agisce con delicatezza su ciglia e contorno occhi, contribuendo a mantenerli nutriti e protetti. Privo di profumo, ma naturalmente delicato, è pensato per garantire la massima tollerabilità cutanea. Dermatologicamente e oftalmologicamente testato, è perfetto per un utilizzo quotidiano. Contiene: Aloe Vera : svolge un’azione lenitiva, idratante e rinfrescante, aiutando a calmare la pelle delicata del contorno occhi. Omega 3-6 : nutrono e proteggono la pelle, contribuendo a rinforzare la barriera cutanea e a mantenere ciglia sane e forti.",
    ...
    },
    {
      ...
      "subtitle_it": "Trattamento labbra volumizzante con peptide clinicamente testato. Idrata, rimpolpa e illumina, donando labbra più piene, morbide e levigate con un effetto gloss naturale.",
      "description_it": "Pepti Boom è il trattamento labbra di nuova generazione che unisce la sensorialità di un lip oil all’efficacia di un attivo peptidico clinicamente testato, per un effetto volumizzante visibile e naturale. La sua texture ultra confortevole nutre, rimpolpa e protegge le labbra, lasciandole subito morbide, levigate e luminose con un finish glossy senza effetto appiccicoso. Grazie alla sua azione progressiva, migliora giorno dopo giorno l’aspetto delle labbra, rendendole più piene, definite e visibilmente più sane. Può essere utilizzato da solo o come primer, per valorizzare al massimo il make-up labbra. Contiene: MAXI-LIP® : peptide brevettato che stimola la produzione di collagene, migliorando volume, definizione e idratazione delle labbra. Vitamina E : potente antiossidante che protegge dai radicali liberi e dona morbidezza.",
    ...
    },
    {
      ...
      "subtitle_it": "Nutre, rinforza e stimola la crescita per ciglia più lunghe, folte e voluminose in sole 8 settimane! Formula innovativa con 7 attivi potenti Risultati visibili e testati: Maggiore lunghezza e densità Riduzione della caduta Sguardo più intenso e definito Perfetto per chi desidera ciglia e sopracciglia più sane e forti, in modo naturale!",
      "description_it": "Siero ciglia e sopracciglia allungante e rinforzante, con un complesso peptidico e cellule meristematiche di Vite Rossa. Nutre e stimola la crescita delle ciglia, donando maggiore volume e risvegliando la loro naturale vitalità, con risultati visibili in 8 settimane. Efficacia clinicamente testata",
    ...
    },
    {
      ...
      "subtitle_it": "Idratazione profonda, effetto rimpolpante immediato! Vuoi una pelle più fresca, luminosa e levigata sin dalla prima applicazione? Pump & Plump è il siero viso che fa per te! La sua formula leggera e setosa agisce come un vero booster di idratazione , donando un aspetto radioso e sano. Ingredienti chiave & Benefici: Pumpcoll® – Attivo innovativo da zucca (upcycling) che stimola il collagene e migliora l’elasticità della pelle. Argireline Amplified® – Peptide biomimetico effetto botox-like per una pelle più distesa. Acido Ialuronico – Idrata in profondità, lasciando la pelle morbida e uniforme. Risultato? Pelle visibilmente più rimpolpata, levigata e radiosa! Provalo ora e regala alla tua pelle un trattamento idratante e rimpolpante unico!",
      "description_it": "PUMP & PLUMP – SIERO VISO RIMPOLPANTE Con Pumpcoll® Siero viso rimpolpante, vero booster di idratazione per un aspetto fresco e luminoso sin dalla prima applicazione. La sua formula leggera e setosa combina: • Pumpcoll®, un innovativo attivo derivato da zucca tramite upcycling che stimola la produzione di collagene e migliora l’elasticità della pelle. • Argireline Amplified®, un peptide di ultima generazione, biomimetico, dall’effetto botox-like. Con Pump&Plump la pelle appare visibilmente più rimpolpata, levigata e radiosa. ATTIVI • Pumpcoll®: bioliquefatto vegetale da upcycling ad azione testata rassodante, rimpolpante, tonificante, idratante. • Argireline Amplified® peptide: peptide biomimetico, riduce le rughe di espressione con un’azione di rilassamento muscolare botox-like",
    ...
    },
    {
      ...
      "subtitle_it": "Effetto opacizzante | Pelle uniforme e levigata Formula leggera in gel : si assorbe all’istante, lasciando la pelle fresca e uniforme. Perfetto anche come base trucco! Ingredienti chiave: Zinco PCA – Purifica, riequilibra e aiuta a contrastare le impurità. Acido Salicilico – Leviga, lenisce e riduce l’eccesso di sebo per una pelle visibilmente più uniforme. Risultato? Una pelle perfetta, opaca e senza imperfezioni!",
      "description_it": "STAY POREFECT – TRATTAMENTO VISO PERFEZIONATORE PORI DILATATI Opacizzante Zinco PCA + Acido Salicilico La sua texture in gel fresca e leggera si fonde istantaneamente uniformando la grana della pelle per un effetto impeccabile. Ottimo come base trucco. ATTIVI • Zinco PCA: azione purificante, antibatterica • Acido Salicilico: disarrossante con azione lenitiva e levigante, questo siero riduce l’eccesso di sebo e minimizza le imperfezioni. • Bakuchiol: alternativa naturale al retinolo, ma privo di effetto irritante. Sebo-riequilibrante, antirughe, riduce le macchie cutanee • Prostructure®: riduce la visibilità dei pori cutanei",
      ...
      "images": {
        "hero": "immagini/everby/trattamento-viso-perfezionatore-pori-dilatati-stay-porefect/hero.webp",
    ...
    },
    {
      ...
      "subtitle_it": "Mousse doccia al tè verde e Neroli è ideata per pelli delicate e sensibili. La sua fragranza dalle note frizzanti stimola e rivitalizza. La sua funzione è quella di tonificare, idratare e proteggere la pelle.",
      "description_it": "Mousse doccia al tè verde e Neroli rivitalizzante e dalla schiuma morbida e soffice grazie agli agenti schiumogeni 100% vegetali.",
      ...
      "images": {
        "hero": "immagini/estratti/bagno-doccia-tè-verde/hero.webp",
        "detail_1": "immagini/estratti/bagno-doccia-tè-verde/det-01.webp",
    ...
    },
    {
      ...
      "subtitle_it": "Burro di Karitè per viso, mani e corpo privo di profumo e allergeni. Nutriente, protettivo è arricchito di Vitamina E, è l’ideale per irritazioni, dermatiti e danni causati dal clima freddo.",
      "description_it": "Il Burro di Karité è stato selezionato dai Laboratori Athena’s tra le migliori qualità da spremitura a freddo.",
      ...
      "images": {
        "hero": "immagini/estratti/burro-di-karité-vitamina-e/hero.webp",
        "detail_1": "immagini/estratti/burro-di-karité-vitamina-e/det-01.webp",
        "detail_2": "immagini/estratti/burro-di-karité-vitamina-e/det-02.webp"
      },
      "actives_main": [
        "Burro di Karité",
        "Vitamina E",
    ...
    },
    {
      ...
      "subtitle_it": "CREMA CORPO RIVITALIZZANTE ARMONIZZANTE con Olio Essenziale di Rosa Damascena",
      "description_it": "Crema corpo aromaterapica con Olio Essenziale di Rosa Damascena: soffice, setosa, rivitalizza e armonizza la pelle con il lusso naturale della rosa.",
    ...
    },
    {
      ...
      "subtitle_it": "La crema mani e unghie naturale, a base di olio di Cotone e proteine del riso, protegge la pelle, donando un piacevole effetto vellutato. È una crema a rapido assorbimento e non unge.",
      "description_it": "L’Erboristica di Athena’s ha ideato questa crema delicata e fluida per mani e unghie per combattere le aggressioni esterne, stress ambientali come freddo, prodotti chimici, lavaggi.",
    ...
    },
    {
      ...
      "subtitle_it": "L’Erboristica di Athena’s ha pensato a una formula del tutto naturale per il doccia schiuma all’olio di Camelia. Ha una fragranza intensa, dolce fiorita ed è setificante e rivitalizzante.",
      "description_it": "Il doccia schiuma all’Olio di Camelia Japonica e Proteine del Riso idrata e nutre la pelle, risanandone il tono e regalandole morbidezza.",
      "usage_it": "Distribuisci il prodotto direttamente sulla pelle bagnata, massaggia delicatamente e risciacqua.",
    ...
    },
    {
      ...
      "subtitle_it": "Il doccia schiuma a base di olio di Patchouli, dalla fragranza esotica-orientale, è 100% naturale. Grazie all’azione rivitalizzante e setificante e alle proprietà riequilibranti dell’olio di Nerolì, la pelle risulterà tonica e vellutata.",
      "description_it": "Il doccia schiuma, del tutto naturale e dalla fragranza esotica-naturale, accompagnerà il vostro bagno per ottenere una pelle tonica e vellutata.",
      "usage_it": "Distribuisci il prodotto direttamente sulla pelle bagnata, massaggia delicatamente e risciacqua.",
    ...
    },
    {
      ...
      "subtitle_it": "La maschera per capelli ai Semi di Lino e Burro di Karité garantisce brillantezza e nutrimento ai capelli sfibrati e devitalizzati. Svolge un’azione anti-crespo, riparando la cheratina dei capelli.",
      "description_it": "Trattamento intensivo a base di principi attivi naturali che nutre, ripara e fortifica in profondità tutti i tipi di capelli, specialmente quelli trattati e devitalizzati.",
      ...
      "images": {
        "hero": "immagini/estratti/maschera-per-capelli-semi-di-lino-e-karité/hero.webp",
        "detail_1": "immagini/estratti/maschera-per-capelli-semi-di-lino-e-karité/det-01.webp",
        "detail_2": "immagini/estratti/maschera-per-capelli-semi-di-lino-e-karité/det-02.webp"
      },
      "actives_main": [
    ...
    },
    {
      ...
      "subtitle_it": "La mousse doccia vegetale al Bergamotto è formulata con detergenti di origine vegetale. È idratante, rivitalizzante e presenta una profumazione fresca e agrumata.",
      "description_it": "La mousse doccia è un detergente di origine vegetale contenente oli essenziali di Bergamotto e Abete Bianco, che stimolano la circolazione, conferendo benessere e relax.",
      "usage_it": "Su pelle bagnata, sotto la doccia o in vasca, massaggiare il corpo con una generosa quantità di mousse per qualche minuto. Risciacquare con cura. Completare il trattamento utilizzando, prima della mousse doccia, due volte a settimana, lo scrub corpo ai granuli di albicocca.",
    ...
    },
    {
      ...
      "subtitle_it": "OLIO CORPO CONCENTRATO RIVITALIZZANTE ARMONIZZANTE con Olio Essenziale di Rosa Damascena",
      "description_it": "Olio aromaterapico setificante concentrato, a base di Olio di Mandorle ed Olio Essenziale di Rosa Damascena.",
    ...
    },
    {
      ...
      "subtitle_it": "Il sapone vegetale al burro di karité è indicato per pelli secche. Ha una funzione protettiva e idratante. Regala una detergenza riequilibrante e delicata per viso e corpo.",
      "description_it": "Sapone vegetale al Burro di Karitè 100% naturale e biodegradabile: protegge e idrata le pelli secche con una detergenza riequilibrante e delicata.",
      ...
      "images": {
        "hero": "immagini/estratti/sapone-vegetale-al-burro-di-karité/hero.webp",
        "detail_1": "immagini/estratti/sapone-vegetale-al-burro-di-karité/det-01.webp",
        "detail_2": "immagini/estratti/sapone-vegetale-al-burro-di-karité/det-02.webp"
      },
      "actives_main": [
        "Burro di Karité",
    ...
    },
    {
      ...
      "subtitle_it": "Puri oli vegetali e Amido di Riso Disarrossante per viso e corpo Ideale anche per i bambini",
      "description_it": "Sapone vegetale all’Amido di Riso lenitivo e disarrossante: purifica dolcemente viso e corpo con puri oli vegetali, ideale anche per le pelli sensibili dei bambini.",
      "usage_it": "Insapona le mani bagnate e risciacqua.",
    ...
    },
    {
      ...
      "subtitle_it": "Puri oli vegetali e Olio Extravergine di Oliva Biologico Azione idratante, protettiva Assicura alla pelle nutrimento ed un tocco morbido e vellutato",
      "description_it": "Sapone solido vegetale particolarmente indicato per le pelli più sensibili, ideale anche sotto la doccia.",
    ...
    },
    {
      ...
      "subtitle_it": "Il sapone vegetale di Marsiglia svolge un’azione idratante e restitutiva. È ideale per una detergenza delicata di viso e corpo.",
      "description_it": "Il sapone vegetale di Marsiglia, grazie all’ Olio Extravergine di Oliva BIO, ha proprietà emollienti.",
      "usage_it": "Insapona le mani bagnate e risciacqua.",
    ...
    },
    {
      ...
      "subtitle_it": "Il sapone idratante 100% vegetale al Monoi di Tahiti, L’Olio di Monoi è ottenuto dalla macerazione dei fiori di Gardenia Tahitiensis, è conosciuto ed apprezzato per le sue spiccate proprietà antiossidanti, nutrienti ed idratanti e rende la pelle morbida e setosa al tatto.",
      "description_it": "Sapone idratante 100% vegetale con pregiato Olio di Monoï di Tahiti: lava delicatamente e lascia la pelle morbida con una fragranza esotica.",
      "usage_it": "Insapona le mani bagnate e risciacqua.",
    ...
    },
    {
      ...
      "subtitle_it": "Shampoo naturale alla Betulla e menta piperita per capelli grassi. Con agenti schiumogeni di origine naturale, deterge la cute e i capelli delicatamente, lasciandoli splendenti e setosi.",
      "description_it": "Questo shampoo purificante è ricco di estratti vegetali riequilibranti, lenitivi e seboregolatori.",
    ...
    },
    {
      ...
      "subtitle_it": "Lo shampoo naturale riparatore ai semi di lino e Burro di Karité ripara in profondità i capelli secchi e sfibrati",
      "description_it": "Lo shampoo naturale riparatore ai semi di lino e burro di Karité è ideale per capelli secchi, sfibrati e trattati.",
      "usage_it": "Applicare lo Shampoo sui capelli umidi, massaggiare per alcuni minuti cute e capelli, favorendo la diffusione dei principi attivi naturali sulla superficie del capello, risciacquare con cura.",
      ...
      "images": {
        "hero": "immagini/estratti/shampoo-riparatore-semi-di-lino-e-karité/hero.webp",
        "detail_1": "immagini/estratti/shampoo-riparatore-semi-di-lino-e-karité/det-01.webp",
        "detail_2": "immagini/estratti/shampoo-riparatore-semi-di-lino-e-karité/det-02.webp"
      },
      "actives_main": [
        "Olio di Semi di Lino",
        "Burro di Karité",
    ...
    },
    {
      ...
      "line": "illumia",
      "brand": "erboristica",
      "name_it": "CREMA VISO ANTIMACCHIE",
      "url": "https://www.erboristica.com/illumia/crema-viso-antimacchie/",
      "subtitle_it": "Crema viso antimacchie, schiarisce le macchie grazie a pigmenti ottici riflettenti di ultima generazione. SPF 30 UVB – UVA",
      "description_it": "Crema viso concentrata intensiva antimacchia: riduce le macchie sul viso e ne previene la ricomparsa.",
    ...
    {
      "id": "illumia-siero-viso-antimacchie",
      "sku": "IL-SER",
      "line": "illumia",
      "brand": "erboristica",
      "name_it": "SIERO VISO ANTIMACCHIE",
      "subtitle_it": "Illuminante uniformante",
      "description_it": "Siero viso con Vitamina C stabilizzata e Luminescine® brevettato: riduce le macchie scure, illumina l'incarnato e ripristina un colorito uniforme e luminoso.",
      "usage_it": "Mattina e sera su pelle pulita e asciutta. Applicare prima della crema idratante con movimenti circolari ascendenti. Per ottimizzare l'efficacia, associare alla Crema Giorno Antimacchie SPF 30.",
      "actives_main": [
      ...
      "format": "30 ml",
      "natural_pct": null,
      "inci": "Aqua [Water], 3-0-Ethyl ascorbic acid, Hydrolyzed verbascum thapsus flower, Niacinamide, Sodium hyaluronate, Glycerin, Panthenol, Betaine, Propanediol, Xanthan gum, Citric acid, Tetrasodium glutamate diacetate, Ethylhexylglycerin, Phenoxyethanol.",
      "certifications": [
        "dermatologico",
        "vegan",
        "made-in-italy"
      ...
      "images": {
        "hero": "immagini/illumia/siero-viso-antimacchie/hero.webp",
        "detail_1": "immagini/illumia/siero-viso-antimacchie/det-01.webp",
        "detail_2": "immagini/illumia/siero-viso-antimacchie/det-02.webp"
      }
    },
    {
    ...
    },
    {
      ...
      "subtitle_it": "BALSAMO STRUCCANTE WATERPROOF POLVERE DETERGENTE",
      "description_it": "La doppia detersione è un innovativo trattamento in due fasi della beauty routine quotidiana.",
    ...
    },
    {
      ...
      "subtitle_it": "Un innovativo Elisir di Bellezza per il corpo che dona istantaneamente idratazione e nutrimento. Provalo al posto della tua abituale crema corpo! Amerai la sua texture ultra sensoriale dal tocco leggero e setoso che si assorbe rapidamente, lasciando la pelle morbida ed estremamente vellutata.",
      "description_it": "Formula bifasica potenziata grazie alla miscela di attivi concentrati e piante alpine infuse in acque termali (Water Infusion Technology), ricchissime in sali minerali dalle proprietà.",
    ...
    },
    {
      ...
      "subtitle_it": "La crema corpo della nuova linea Nutra Repair è una crema rigenerante e nutriente, con olio di Baobab Biologico equosolidale e cellule staminali vegetali.",
      "description_it": "La Crema Corpo contenente Olio di Baobab Biologico, Acido Ialuronico e mix di vitamine (A, C, E) è completamente naturale e assicura tono ed elasticità alla pelle.",
    ...
    },
    {
      ...
      "subtitle_it": "Crema Viso ultra-rigenerante, nutriente ed intensiva, con Olio di Baobab Biologico e Cellule Staminali Vegetali.",
      "description_it": "La Crema Viso Olio di Baobab Biologico, studiata per tutti i tipi di pelle, contiene Vitamina C, forte antiossidante, e Acido Ialuronico: insieme donano idratazione e innescano una.",
    ...
    },
    {
      ...
      "subtitle_it": "OLIO CORPO & CAPELLI Olio di Baobab Bio & Omega 3-6 Rigenerante – Nutriente Pelle e capelli nutriti e luminosi",
      "description_it": "L’ Olio di Baobab Biologico Equosidale, ricco di Omega 3-6 e 9, dall’azione antiossidante, rigenera e nutre intensamente la pelle e la fibra capillare migliorando l’elasticità e.",
    ...
    },
    {
      ...
      "subtitle_it": "OLIO VISO MULTIVITAMINICO Puro Olio di Baobab Biologico Rigenerante – Riparatore",
      "description_it": "Olio concentrato viso dalla texture fondente a base di OLIO PURO DI BAOBAB BIOLOGICO EQUOSOLIDALE.",
    ...
    },
    {
      ...
      "subtitle_it": "La crema corpo all’olio di Argan presenta una formulazione totalmente naturale, nutriente e idratante. L’olio di Argan conferisce un’azione elasticizzante ed emolliente.",
      "description_it": "La crema corpo all’olio di Argan presenta una formulazione totalmente naturale, nutriente e idratante.",
      "usage_it": "Applica la crema corpo tutti i giorni dopo la doccia, quando la pelle è ancora umida.",
    ...
    },
    {
      ...
      "subtitle_it": "La crema esfoliante, a base di Olio e granuli di Argan per peeling al viso, rende la pelle più luminosa e rivitalizzata per ottenere uno straordinario effetto seta. È un esfoliante delicato, che libera la pelle da impurità e cellule morte.",
      "description_it": "Il momento dell’esfoliazione è fondamentale per la nostra pelle, poiché rimuove ed elimina dalla superficie dell’epidermide le cellule morte e le impurità accumulate, che sono la causa.",
    ...
    },
    {
      ...
      "subtitle_it": "La mousse doccia a base di olio di Argan ha proprietà idratanti e protettive, che lasciano la pelle delicatamente vellutata e profumata.",
      "description_it": "La mousse doccia naturale all’olio di Argan è un vero elisir di bellezza, che svolge un’azione nutriente ed emolliente.",
      "usage_it": "Su pelle bagnata, sotto la doccia o in vasca, massaggiare il corpo con una generosa quantità di mousse per qualche minuto. Risciacquare con cura. Completare il trattamento utilizzando, prima della mousse doccia, due volte a settimana, lo scrub corpo ai granuli di albicocca.",
    ...
    },
    {
      ...
      "subtitle_it": "L’olio di Argan per il corpo è un trattamento naturale e biologico di bellezza ottenuto da una miscela di oli preziosi, che illuminano e rigenerano la pelle.",
      "description_it": "Per una pelle morbida ed elastica l’Erboristica di Athena’s ha creato l’olio corpo argan bio.",
    ...
    },
    {
      ...
      "subtitle_it": "Il sapone vegetale all’olio di argan è ricco di vitamina A, Omega 3 e 6. Svolge una funzione idratante per viso e corpo.",
      "description_it": "Il sapone vegetale, ricco di olio di Argan, è ottenuto esclusivamente dalla saponificazione di puro olio vegetale di palma.",
      "usage_it": "Insapona le mani bagnate e risciacqua.",
    ...
    },
    {
      ...
      "subtitle_it": "La crema viso all’Olio di Argan 100% naturale con acido ialuronico vegetale ha un effetto anti-age e idratante. Contrasta visibilmente i segni del tempo, leviga i tratti, ridensifica i tessuti e ridisegna l’ovale.",
      "description_it": "La crema viso all’Olio di Argan e Acido ialuronico è adatta a contrastare i segni del tempo, la disidratazione e la perdita di tono che si accusano dopo i 30 anni.",
    ...
    },
    {
      ...
      "subtitle_it": "La Crema Corpo all’Olio di Mandorle dolci è una fluida, nutriente, setosa e restitutiva. È studiata per una pelle secca, atonica e spenta, non più elastica e luminosa.",
      "description_it": "Crema Corpo all’Olio di Mandorle dolci, per pelli secche e disidratate, una crema corpo fluida dalle proprietà nutrienti e idratanti.",
    ...
    },
    {
      ...
      "subtitle_it": "La Crema all’Olio di Mandorle dolci ad assorbimento rapido per mani e unghie non unge, ma nutre, ripara e rende le mani morbide e setose.",
      "description_it": "I Laboratori Athena’s hanno formulato questa crema, dalla texture non untuosa e di facile assorbimento, che dona morbidezza e idratazione a mani e unghie, contrastando gli agenti.",
    ...
    },
    {
      ...
      "subtitle_it": "La Crema Viso Prime Rughe all’olio di mandorle dolci contrasta i primi segni dell’invecchiamento, mantenendo elasticità e levigatezza e valorizzando la luminosità al viso.",
      "description_it": "La Crema viso Prime Rughe, studiata dagli esperti dei Laboratori Athena’s, è adatta non solo per coloro che vogliono contrastare i primi segni del tempo causati da scarsa idratazione e.",
    ...
    },
    {
      ...
      "subtitle_it": "Il Bagno Doccia all’Olio di Mandorle è una mousse straordinariamente delicata, formulata solo con tensioattivi di origine vegetale. Ideata per pelli atoniche e disidratate, dona nutrimento, idratazione e ha una profumazione morbida e fiorita.",
      "description_it": "Il Bagno Doccia all’Olio di Mandorle contiene il succo di aloe vera biologico, che assicura una pelle perfettamente idratata e nutrita in profondità, e l’olio di mandorle dolci dalle.",
      "usage_it": "Distribuisci il prodotto direttamente sulla pelle bagnata, massaggia delicatamente e risciacqua.",
    ...
    },
    {
      ...
      "subtitle_it": "L’Olio di Mandorle dolci per viso e corpo è 100% naturale e ricco di vitamina E. Ha funzione antiossidante, combatte i radicali liberi ed è ideale sotto la doccia.",
      "description_it": "L’Olio di Mandorle Dolci, dalle proprietà emollienti, elasticizzanti e restitutive, si ottiene dal nocciolo di Mandorla.",
    ...
    },
    {
      ...
      "subtitle_it": "Puri oli vegetali e Olio di Mandorle Dolci Ideale per tutti i tipi di pelle di adulti e bambini Azione lenitiva ed elasticizzante",
      "description_it": "Sapone solido vegetale, ideale anche sotto la doccia, per tutti i tipi di pelle.",
      "usage_it": "Insapona le mani bagnate e risciacqua.",
    ...
    },
    {
      ...
      "subtitle_it": "Trattamento viso 2 in 1 : perle + siero in un solo gesto PERLE – Coenzima Q10 : antiossidante, stimola il collagene SIERO – Argireline Amplified® : effetto Botox-like, distende le rughe Texture setosa e idratante : comfort immediato sulla pelle Risultato : pelle luminosa, levigata e compatta",
      "description_it": "Trattamento Viso 2 in 1 – Perle & Siero Un innovativo rituale di bellezza che unisce la delicatezza di una texture setosa all’efficacia di attivi mirati.",
    ...
    },
    {
      ...
      "subtitle_it": "Perché lo amerai PERLE – Niacinamide – donano luminosità, idratazione e rinforzano la barriera cutanea. SIERO – Retinolo – stimola la rigenerazione, migliora elasticità e compattezza. Doppia azione in un solo gesto – attivi puri e potenti che si fondono sulla pelle. Texture setosa e avvolgente – trasforma la tua routine in un rituale di bellezza. Risultato visibile – pelle più levigata, uniforme e radiosa giorno dopo giorno.",
      "description_it": "Trattamento Viso 2 in 1 Un elisir innovativo che unisce la freschezza setosa del siero al potere delle perle attive.",
    ...
    },
    {
      ...
      "subtitle_it": "Perché amarlo: PERLE – Vitamina C stabilizzata: uniformante, dona radiosità al viso SIERO – Luminescine®: illuminante Texture setosa che si fonde con la pelle in un istante Doppio trattamento in un solo gesto: idrata, uniforma, illumina Risultato: incarnato radioso, compatto e levigato",
      "description_it": "Trattamento viso 2 in 1 con perle di Vitamina C e siero Luminescine® Un gesto di bellezza innovativo che unisce la freschezza di perle setose e il potere di un siero prezioso.",
      "usage_it": "Dopo aver deterso il viso, applicare mattina e/o sera 5-6 gocce di siero su viso, collo o décolleté. Massaggiare la pelle delicatamente ed attendere il completo assorbimento del prodotto. Può essere utilizzato da solo o in combinazione con l’abituale trattamento in crema.",
    ...
    },
    {
      ...
      "subtitle_it": "Purificante, Opacizzante, Anti-imperfezioni Crema viso specifica per pelli miste e impure. Garantisce idratazione e azione anti-età migliorando imperfezioni, con effetto opacizzante e normalizzante.",
      "description_it": "Le imperfezioni non contraddistinguono solo la pelle giovane, ma possono interessare anche in età matura la pelle mista ed impura; complici alterazioni ormonali, stress ed inquinamento.",
    ...
    },
    {
      ...
      "subtitle_it": "Il detergente viso per pelli miste e impure della linea Purysens è dermopurificante, sebo-equilibrante e lenitivo. Garantisce una pelle purificata in profondità e detersa.",
      "description_it": "I Laboratori Athena’s hanno pensato a un detergente viso dermopurificante per pelli miste e impure con il quale trattare quotidianamente la T-zone.",
    ...
    },
    {
      ...
      "subtitle_it": "MASCHERA VISO ARGILLA ROSA & PREBIOTICO Elimina in profondità impurità e punti neri senza irritare, restringe i pori e riduce le imperfezioni.",
      "description_it": "Maschera per il viso a base di Argilla Rosa , Olio di Calendula , Bardana e Zinco e arricchita con Prebiotico Vegetale .",
    ...
    },
    {
      ...
      "subtitle_it": "Il Balsamo Dopobarba Naturale da Uomo è studiato per pelli sensibili e delicate. Privo di alcool, arricchito con estratto di Ginseng e Aloe Vera, idrata e lenisce la pelle.",
      "description_it": "Il Balsamo Dopobarba Uomo 100% Naturale con la sua consistenza cremosa, non grassa e privo di alcool, è studiato per rendere perfettamente idratata e morbida anche la pelle più.",
    ...
    },
    {
      ...
      "subtitle_it": "Il Balsamo Dopobarba Naturale da Uomo è studiato per pelli sensibili e delicate. Privo di alcool, arricchito con estratto di Ginseng e Aloe Vera, idrata e lenisce la pelle.",
      "description_it": "Balsamo dopobarba, privo di alcool, appositamente studiato per la pelle più esigente, assicura protezione ed un’azione rivitalizzante dopo la rasatura.",
    ...
    },
    {
      ...
      "subtitle_it": "Contorno occhi uomo anti-età che riduce borse e occhiaie. Con Bakuchiol, Acido Ialuronico e peptide biomimetico, idrata, leviga e dona uno sguardo più fresco e riposato.",
      "description_it": "Trattamento contorno occhi specifico per la pelle maschile, studiato per contrastare borse, occhiaie e primi segni di invecchiamento.",
      ...
      "images": {
        "hero": "immagini/uomo/contorno-occhi-uomo-anti-età/hero.webp",
        "detail_1": "immagini/uomo/contorno-occhi-uomo-anti-età/det-01.webp",
    ...
    },
    {
      ...
      "subtitle_it": "La crema viso antirughe e idratante da uomo, a base di Acido Ialuronico e Vitamina B5, restituisce al viso un aspetto meno stanco, tonico e rivitalizzato. Priva di alcol, ha una consistenza piacevole e non grassa, che la rende facile da stendere.",
      "description_it": "Uno stile di vita stressante, l’inquinamento e un clima sempre più mutevole e capriccioso mettono a dura prova la pelle dell’uomo e sono tra le cause di rughe precoci, pelle.",
    ...
    },
    {
      ...
      "subtitle_it": "Crema viso rivitalizzante & protettiva Caffè verde + Vitamin Complex",
      "description_it": "LA SOLUZIONE : Il rimedio specificatamente studiato per una pelle spenta e stressata che richiede un booster di vitalità e di rinnovamento cellulare.",
    ...
    },
    {
      ...
      "subtitle_it": "Il Deodorante spray No gas da Uomo è stato progettato dai Laboratori Athena’s per dare un’efficacia antibatterica e una protezione anti odore fino a 24H. Un deodorante molto piacevole che non irrita la pelle grazie alla ricchezza dei suoi principi attivi naturali.",
      "description_it": "Grazie ai principi attivi come Zinco PCA e Pantenolo, il Deodorante spray No gas garantisce un effetto anti-odore e battericida.",
    ...
    },
    {
      ...
      "subtitle_it": "Eau de Toilette per Uomo ha una fragranza speziata e legnosa, con accordi agrumati di bergamotto e mandarino che si adagiano su un cuore di pepe rosa e cannella.",
      "description_it": "Eau de Toilette per Uomo ha una fragranza magnetica ed avvolgente: speziata e legnosa con accordi agrumati di bergamotto e mandarino su un cuore di pepe rosa e cannella.",
    ...
    },
    {
      ...
      "subtitle_it": "Il Fluido Idratante Barba e Viso, a base di Acido Ialuronico e vitamina E, ha una funzione idratante che dona morbidezza anche alle barbe più dure e ribelli. La sua texture è fresca, non untuosa e piacevole sulla pelle.",
      "description_it": "Il Fluido Idratante Barba e Viso dalla profumazione legnosa-speziata e dalla texture piacevole, fresca e non untuosa, è un trattamento 100% Naturale contenente Acido Ialuronico.",
    ...
    },
    {
      ...
      "subtitle_it": "L’Olio da Barba è 100% Naturale, Vegetale e Vegan. Dona alla barba morbidezza, lucentezza e protezione.",
      "description_it": "Un mix di 7 oli vegetali (jojoba- semi di lino, riso, macadamia, karité, soia, canola) e vitamina E, che, oltre a svolgere un’azione emolliente, rafforza il bulbo pilifero, idrata la.",
    ...
    },
    {
      ...
      "subtitle_it": "Il sapone vegetale per uomo al burro di Karité e Ginkgo Biloba funge da antiossidante ed energizzante.",
      "description_it": "Il sapone vegetale per uomo al burro di Karité e Ginkgo Biloba è ricco di vitamine e antiossidanti, ideato per una delicata detergenza di mani, viso e corpo.",
      "usage_it": "Insapona le mani bagnate e risciacqua.",
    ...
    },
    {
      ...
      "subtitle_it": "Shampoo doccia, delicato sui capelli, a base di agenti schiumogeni vegetali. È realizzato per la pelle e la cute maschile, contiene l’estratto di Ginkgo Biloba e Pantenolo, che lo rendono energizzante, rinvigorente, tonificante e idratante.",
      "description_it": "Una mousse a base di tensioattivi di origine vegetale, che allontana le tensioni muscolari e conferisce freschezza, delicatezza e idratazione a corpo e capelli.",
    ...
    },
    {
      ...
      "subtitle_it": "Il siero viso uomo ad effetto lifting contiene acido ialuronico concentrato. È perfetto in ogni momento della giornata come dopo sole, dopobarba, contro stimoli ambientali (freddo, vento, inquinamento e smog).",
      "description_it": "Il siero viso uomo privo di profumo e alcool è un trattamento intensivo anti-age.",
    ...
    },
    {
      ...
      "usage_it": "Applicare la sera. Il dosaggio (una goccia per occhio) è sufficiente.",
